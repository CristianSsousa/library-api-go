...
//	"bytes"
//	"encoding/json"
//	"library-api-go/internal/controllers"
//	"library-api-go/internal/domain"
...
//	author := domain.Author{Name: "John Doe 2",}
//	valueJson, _ := json.Marshal(author)
...
//	book := domain.Book{Title: "Boooook",}
//	valueJson, _ := json.Marshal(book)
...
//	author := domain.Author{Name: "John Doe",}
...
//	author := domain.Author{Name: "John Doe",}
//	database.DB.Create(&author)
//	book := domain.Book{Title: "Book 1", AuthorID: author.ID,}
